...
funccongeda = getattr(travian_caserma, 'congeda_tutto')
amidiff =  datetime.timedelta(hours=5, minutes=0, seconds= 0)
...
def congeda(departuretime, startvillo, func, **args):
    time_util.wait_until(departuretime-amidiff)
    travian_login.effettua_login()
    dictvills =  travian_villaggi.getvillaggi()
...
atCAT= datetime.datetime(2009,3,23,5,50,0)


congeda(atCAT,  "G1-Matinella", funccongeda)
