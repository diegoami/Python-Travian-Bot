...
at2B = datetime.timedelta(hours=15, minutes=45, seconds= 44)
at3C = datetime.timedelta(hours=12, minutes=27, seconds= 38)
at3B = datetime.timedelta(hours=12, minutes=13, seconds= 36)
at6B = datetime.timedelta(hours=14, minutes=18 , seconds= 37)
at6C = datetime.timedelta(hours=14, minutes=3 , seconds= 32)
at0B = datetime.timedelta(hours=9, minutes=8, seconds= 2)
...
conquista.add_attacco(5,at3C,"3C-Stetzig", t1Arg=40,  t9Arg=2,  cArg=3)
...
conquista.add_attacco(5,at6C,"6C-Gettysburg", t1Arg=40,  t9Arg=2,  cArg=3)
