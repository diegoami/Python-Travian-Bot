...
arrivaltime0 = datetime.datetime(2009,3,4,8,37,0)
arrivaltime0b = datetime.datetime(2009,3,4,8,37,1)

arrivaltime1 = datetime.datetime(2009,3,4,8,37,10)
arrivaltime1b = datetime.datetime(2009,3,4,8,37,11)

arrivaltime2 = datetime.datetime(2009,3,4,8,37,16)
arrivaltime2b = datetime.datetime(2009,3,4,8,37,17)

arrivaltime3 = datetime.datetime(2009,3,4,8,37,24)
arrivaltime3b = datetime.datetime(2009,3,4,8,37,25)


funcninja = getattr(travian_addestra, 'spediscitruppe')

ninja(arrivaltime0 , ntLegnagoLancere, "B1-Legnago", funcninja ,t1Arg=600, xArg=-17, yArg=-233, cArg=2)
ninja(arrivaltime0b , ntOstigliaLancere, "C1-Ostiglia", funcninja ,t1Arg=600, xArg=-17, yArg=-233, cArg=2)
     
ninja(arrivaltime1 , ntLegnagoLancere, "B1-Legnago", funcninja ,t1Arg=600, xArg=-17, yArg=-233, cArg=2)
ninja(arrivaltime1b , ntOstigliaLancere, "C1-Ostiglia", funcninja ,t1Arg=600, xArg=-17, yArg=-233, cArg=2)
ninja(arrivaltime2 , ntLegnagoLancere, "B1-Legnago", funcninja ,t1Arg=600, xArg=-17, yArg=-233, cArg=2)
ninja(arrivaltime2b , ntOstigliaLancere, "C1-Ostiglia", funcninja ,t1Arg=600, xArg=-17, yArg=-233, cArg=2)
ninja(arrivaltime3 , ntLegnagoLancere, "B1-Legnago", funcninja ,t1Arg=600, xArg=-17, yArg=-233, cArg=2)
ninja(arrivaltime3b , ntOstigliaLancere, "C1-Ostiglia", funcninja ,t1Arg=600, xArg=-17, yArg=-233, cArg=2)
