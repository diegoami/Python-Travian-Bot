...
at4A = datetime.timedelta(hours=11, minutes=0, seconds= 25)
at1A = datetime.timedelta(hours=9, minutes=47, seconds= 32)
at5C = datetime.timedelta(hours=7, minutes=55, seconds= 49)
at2B = datetime.timedelta(hours=4, minutes=15, seconds= 26)

conquista = travian_conquista.conquista(arrival, XGO, YGO)
travian_login.login()


conquista.add_attacco(0,at4A,"4A-Hamburg", t3Arg=10000, t6Arg= 4000, t7Arg=800, t8Arg=400,  t9Arg=2, cArg=3, kataArg=25)
conquista.add_attacco(5,at1A,"1A-Kiel", t1Arg=200, t3Arg= 150, t5Arg = 200, t6Arg= 50, t9Arg=1,   cArg=3)
conquista.add_attacco(10,at5C,"5C-Carlsburg", t1Arg=75, t9Arg=2, cArg=3)
conquista.add_attacco(5,at2B,"2B-Rostock", t1Arg=1000, t6Arg= 400, t9Arg=1,   cArg=3)
